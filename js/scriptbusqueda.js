$(document).ready(function(){
    ...
    $('#busqueda').on('keyup', function(){  //Una funcion la cual cada que se presione una tecla, haga la consutla
        ...
        $.ajax({
            ...
            data: {'search': search},
            beforeSend: function(){
                $('#ResultDiv').html('<img src="./img/giftorti.gif"')
            }   
        })
        ...
        .fail(function(){   //En caso de que la consulta esté mal
            alert("Error de algo equisde")
        })
    })
    if(search ="") //Prototipo para que cuando no haya nada escroto, se desaparezca el div.
    {
