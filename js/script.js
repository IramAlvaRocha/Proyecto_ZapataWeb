  ...
  //creacion de las cards
     ...
     .done(function(response){
       ...
       $.each(response, function(index,element){
         html = '<div class="card col-3 col-md-3 text-center mx-auto" mb-3 data-id="'+ element.id +'" style="width: 18rem;">';
         html += '<img src="' + element.imagen + '" class="card-img-top"  width="250" height="150"alt="...">';
         html += '<div class="card-body">';
         html += '<h5 class="card-title">' + element.producto +'</h5>';
         html += '<p class="card-text">'+ element.descripcion + ' <br> <h6>Precio $'+element.precio+'</h6> </p>';
         html += '</div>';
         html += '</div>';
