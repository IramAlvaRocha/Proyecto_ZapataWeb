...
<html lang="es">
  ...
  <div class="row">
      ...
      <div class="col-12 col-md-5 mt-3 text-center ">
          <h2 class="p-1"><span class="iconify" data-icon="ic:twotone-point-of-sale" data-width="60"></span>Reporte de ventas</h2>
          <p>Visualice o descargué el reporte de las ventas </p>
      </div>
